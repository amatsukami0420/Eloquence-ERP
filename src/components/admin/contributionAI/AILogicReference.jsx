...
function AILogicReference() {
  ...
  return (
    ...
    <div className="card mx-auto border-0 shadow-sm p-4 bg-dark text-white h-100" style={{ maxWidth: "450px" }}>
      ...
      <Link to="/admin/contributions" className="btn btn-outline-info w-100">Back to Dashboard</Link>
    </div>
    </div>
  );
}
